...
import { giftAccount } from "@/lib/data";
...
export function GiftRegistry() {
  ...
  const handleCopy = async () => {
    await navigator.clipboard.writeText(giftAccount.accountNumber);
    setCopied(true);
        ...
        <Card className="flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <p className="font-serif text-xl text-[color:var(--ink)]">{giftAccount.bankName}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-serif text-xl text-[color:var(--ink)]">{giftAccount.accountName}</p>
            </div>
          </div>
          <button
            type="button"
